...
\end{enumerate}
Taking a decision on which Open Source Project must be acquired is normally a hard thing. This document aims to be an entry point to follow some very basic steps for facilitating this task, and minimize the risk associated to facing a wrong selection.
