...
%Gummi|061|=)
\title{\textbf{An interview}}
\author{Bitergia: Whoever\\
...
\Que {Why did Bitergia decided to get into that business?}
\Ans {...}
...
\Que {Which is the main competitive advantage of producing Free Software for Bitergia?}
\Ans {...}
...
\Que {How many people develops for Bitergia products without working on the Enterprise?}
\Ans {...}

\Que {Which actions has being taking Bitergia to increase comunity?}
\Ans {...}
...
\Que {If Bitergia was to be created today, would Bitergia as start-up choose the same strategy, oriented to Free Software?}
\Ans {...}

\Que {To end this interview, which message would you send to entrepeneurs to promote start up creation around FLOSS?}
\Ans {...}
